 ...
 */
@Component({
  selector: 'sbb-file-selector-dropzone-showcase-example',
  templateUrl: 'file-selector-dropzone-showcase-example.html',
  imports: [
    FormField,
    JsonPipe,
    SbbCardModule,
...
export class FileSelectorDropzoneShowcaseExample {
