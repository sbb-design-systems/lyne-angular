    ...
    sections: [
      ...
      // },
      {
        ...
        entries: [
          ...
          { label: 'Expansion Panel', link: './components/expansion-panel' },
          ...
          { label: 'Icon Sidebar', link: './components/icon-sidebar' },
          ...
          { label: 'Link List Anchor', link: './components/link-list-anchor' },
          ...
          { label: 'Radio Button Group', link: './components/radio-button-group' },
          { label: 'Radio Button Panel', link: './components/radio-button-panel' },
          ...
          { label: 'Timetable Occupancy', link: './components/timetable-occupancy' },
          { label: 'Timetable Occupancy Icon', link: './components/timetable-occupancy-icon' },
          { label: 'Title', link: './components/title' },
          { label: 'Toast', link: './components/toast' },
          { label: 'Toggle', link: './components/toggle' },
          { label: 'Toggle Check', link: './components/toggle-check' },
          { label: 'Tooltip', link: './components/tooltip' },
          { label: 'Train', link: './components/train' },
        ],
      },
    ],
  },
