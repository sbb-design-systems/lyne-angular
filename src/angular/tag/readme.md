...
```html
<sbb-tag-group accessibilityLabel="Select your desired device to filter it">
...
```html
<sbb-tag-group multiple accessibilityLabel="Select your desired font styles to filter it">
