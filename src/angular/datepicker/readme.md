...
If the `<sbb-datepicker>` is used within a [sbb-form-field](/angular/components/form-field/overview)
...
If the two components are used within a [sbb-form-field](/angular/components/form-field/overview),
