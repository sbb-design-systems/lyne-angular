...
import type { SbbOverlayConfig, SbbOverlayRef } from '@sbb-esta/lyne-angular/core/overlay';
...
export class SbbToastService extends SbbOverlayBaseService<SbbToastContainer, SbbToast> {
  ...
  override open<T = unknown | SbbSimpleToast>(
    ...
    if (typeof content === 'string') {
      ...
      return super.open(SbbSimpleToast, configWithComponent) as SbbOverlayRef<T>;
    }
    return super.open(content, config);
  }
}
