...
```html
<sbb-menu-link href="#" iconName="pie-small">Another text</sbb-menu-link>
...
<sbb-menu-link
  href="#"
  sbb-badge="2"
  accessibilityLabel="Show messages, 2 new messages available"
  iconName="pie-small"
>
  Messages
</sbb-menu-link>
...
<sbb-menu>
  <sbb-block-link href="https://www.sbb.ch/en" size="xs">Profile</sbb-block-link>
  <sbb-menu-link sbbInitialFocus icon="link-small" href="https://www.sbb.ch/en">
...
<sbb-menu>
  ...
  <sbb-menu-button disabledInteractive> Edit </sbb-menu-button>
  ...
</sbb-menu>
```
...
[Link to related @sbb-esta/lyne-elements docs](https://lyne-elements.app.sbb.ch/?path=/docs/elements-menu--docs)
