...
Radio-buttons should typically be placed inside a [sbb-radio-button-group](/angular/components/radio-button-group/overview) component
...
for setting a custom [sbb-error](/angular/components/form-field/overview) message
within a [sbb-form-field](/angular/components/form-field/overview).
