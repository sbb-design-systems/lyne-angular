...
As described in [sbb-icon-sidebar-link](/angular/components/sidebar/overview) and
[sbb-icon-sidebar-button](/angular/components/icon-sidebar/overview), it's important to set
