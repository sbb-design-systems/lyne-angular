...
const SBB_BUTTON_CONTROL_VALUE_ACCESSOR: ExistingProvider = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => SbbButtonDirective),
  multi: true,
};
...
@Directive({
  selector: 'sbb-button',
  standalone: true,
  providers: [SBB_BUTTON_CONTROL_VALUE_ACCESSOR],
})
export class SbbButtonDirective extends SbbControlValueAccessor {
