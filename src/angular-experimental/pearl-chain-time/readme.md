...
before and/or after the [sbb-pearl-chain](/angular-experimental/components/pearl-chain/overview).
...
[Link to related @sbb-esta/lyne-elements docs](https://lyne-elements.app.sbb.ch/?path=/docs/experimental-pearl-chain-time--docs)
