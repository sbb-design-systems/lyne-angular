...
- **@sbb-esta/lyne-elements & @sbb-esta/lyne-angular Version** - which version is affected
...
- **Screenshots** - Due to the visual nature of @sbb-esta/lyne-elements & @sbb-esta/lyne-angular,
  screenshots can help the team triage issues far more quickly than a text description.
- **Related Issues** - has a similar issue been reported before?
- **Suggest a Fix** - if you can't fix the bug yourself, perhaps you can point to what might be
  causing the problem (line of code or commit)

You can file new issues by providing the above information [here](https://github.com/sbb-design-systems/lyne-angular/issues/new/choose).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)

- Search [GitHub](https://github.com/sbb-design-systems/lyne-components/pulls)
- and [GitHub](https://github.com/sbb-design-systems/lyne-angular/pulls) for an open or closed PR
...
- In GitHub, send a pull request to `lyne-angular:main`.
...
[github]: https://github.com/sbb-design-systems/lyne-angular
